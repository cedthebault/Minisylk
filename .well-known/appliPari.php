				...
				<div class="themeBlock2" id="themeBlock2" name="themeBlock2">
					<table border="0" >
						<tr>
							<td height="30">
									<ul>
										<li id="cat1" class="o1"><input type="number" style="width:60px" name="ls1" id="ls1" value="0" size="3"/><label for="ts1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Taille</label></li>
										<li id="cat2" class="o2"><input type="number" style="width:60px"  name="ls2" id="ls2" value="0" size="3"/><label for="ts2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Poids</label></li>
										<li id="cat1" class="o3"><input type="text" style="width:80px" name="ls3" id="ls3" value="0" size="10"/><label for="ts3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Date</label></li>
